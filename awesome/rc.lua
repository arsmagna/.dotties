...
tags = {
   names = { "", "",  "", "", ""},
   layout = { layouts[2], layouts[6], layouts[1], layouts[1], layouts[1] }
}
...
mpdwidget = lain.widgets.mpd({
    settings = function()
        ...
        widget:set_markup(markup("#8ab4be", artist) .. title)
    end
})
...
arrl_dl = separators.arrow_left(beautiful.bg_focus2, "alpha") 
arrl_ld = separators.arrow_left("alpha", beautiful.bg_focus2) 
    ...
    local function right_layout_add (...)  
        ...
        if right_layout_toggle then
            ...
            for i, n in pairs(arg) do
                right_layout:add(wibox.widget.background(n ,beautiful.bg_focus2))
            end
        else
